...
// Explicit CORS configuration to allow all origins to fix "Failed to fetch" errors in Flutter/mobile clients
app.use(cors({
    origin: '*',
...
// The /api/problem route remains commented out as requested.

app.get('/', (req, res) => {
  res.json({ 
    message: 'krishipoke API is running and ready for Trainers.',
